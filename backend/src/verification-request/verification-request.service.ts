...
export class VerificationRequestService {
  ...
  async createVerificationRequest(
    newVerificationRequest: CreateVerificationRequestDto,
  ) {
    const { user_id, game_id, rank_id, filepath, createdAt, status } =
    ...
    return verificationRequest
      ? VerificationRequest.fromObject(verificationRequest)
      : null;
  }

  async updateVerificationRequestFilepath(
    id: number,
    filepath: string,
    ...
    return updatedVerificationRequest
      ? VerificationRequest.fromObject(updatedVerificationRequest)
      : null;
  }
  ...
  async updateVerificationRequestStatus(
    updateDto: UpdateVerificationRequestDto,
