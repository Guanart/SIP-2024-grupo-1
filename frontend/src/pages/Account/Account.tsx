      ...
      >
        <form onSubmit={handleSubmit} className="edit-profile-form">
          ...
          <TextField
            ...
            onChange={(event) => {
              const username =
                event.target.value.trim() ?? currentUser?.username;
              setUpdatedUser({
                ...updatedUser,
                ["username"]: username,
              });
          ...
          <TextField
            ...
            onChange={(event) => {
              const avatar = event.target.value.trim() ?? currentUser?.avatar;
              setUpdatedUser({
                ...updatedUser,
                ["avatar"]: avatar,
              });
          ...
          {role === "player" && (
            <TextField
              ...
              onChange={(event) => {
                const biography =
                  event.target.value ?? currentUser?.player?.biography;
      ...
      {!isLoading && (
        <>
          <Container sx={{ mt: "24px" }}>
            ...
            <p>
              Acá pensaba mostrar los 5 tokens más valiosos o algo por el estilo
            </p>
          </Container>
          <Container sx={{ mt: "24px" }}>
            <Typography variant="h6" component="h2">
            ...
            <p>
              Acá pensaba mostrar las últimas 5 publicaciones del Marketplace
            </p>
          </Container>
        </>
      )}
